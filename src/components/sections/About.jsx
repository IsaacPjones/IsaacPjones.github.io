...
export const About = () => {
    ...
    return ( <section id="about" className="min-h-screen flex items-center justify-center py-20">
        ...
        <div className="max-w-3xl mx-auto px-4">
            ...
            <div>
                <img src="IsaacPjones.github.io/src/assets/Isaac.jpeg" alt="A photo of Isaac Jones" className="w-60 h-60 rounded-full mx-auto mb-6 border-4 border-white/10 shadow-lg hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition-all" />
            </div>
